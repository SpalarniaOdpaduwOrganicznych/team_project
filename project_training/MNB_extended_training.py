#training the model with extended dataset
...
df_train = pd.read_csv("project_data/extended_dataset_1.csv")
...
model_filename = 'project_models/model_MNB_extended.joblib'
dump(clf, model_filename)

vectorizer_filename = 'project_models/tfidf_vectorizer_extended.joblib'
